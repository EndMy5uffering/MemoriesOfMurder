...
public static class DialogTexts
{
    ...
    public static Dialog[] dialogsBuegeleisen = new Dialog[4]
    {
            ...
            new List<string>
        {
            ...
            "Kannst du mir nicht ein bisschen hei�es Wasser bringen?",
        },
            new List<int>
            {
                1
        ...
        {
            "Ah... Das tut gut.",
            "Papa war wirklich froh das Mama schnell noch ein Hemd f�r ihn geb�gelt hat.",
            "Ich bin mir auch sicher dass er ihr nie was antuen w�rde.",
        },
            null,
            new List<int>
            {
    ...
    public static Dialog[] dialogsFernseher = new Dialog[3]
    {
        new Dialog(Constants.FERNSEHER,
            new List<string>
        {
            "M�chtest du wieder die drei Fragezeichen sehen?",
        },
            null,
            null,
            new List<NpcStatePair>
        ...
        new Dialog(Constants.FERNSEHER,
            new List<string>
        {
            "Wann l�st du denn deinen 1. Fall?",
        },
            null,
            null,
            new List<NpcStatePair>
        ...
        new Dialog(Constants.FERNSEHER,
            new List<string>
        {
            "Sherlock Holmes ist noch nichts f�r dich."
        },
            null,
            null,
            new List<NpcStatePair>
    ...
    public static Dialog[] dialogsLappe = new Dialog[2]
{
    ...
    public static Dialog[] dialogsMuelleimer = new Dialog[3]
    {
        new Dialog(Constants.MUELLEIMER,
            new List<string>
        {
            "Dieser Kuchen war soooo lecker, hast du noch ein St�ck?"
        },
            null,
            null,
            new List<NpcStatePair>
        ...
        new Dialog(Constants.MUELLEIMER,
            new List<string>
        {
            "Ich frage mich warum sie</b> kein St�ck wollte. Der sah ja auch gut aus."
        },
            null,
            null,
            new List<NpcStatePair>
    ...
    public static Dialog[] dialogsLeiche = new Dialog[2]
    {
         new Dialog(Constants.KIND,
            new List<string>
        {
            "Meine Mutter ist get�tet worden (",
    ...
    public static Dialog[] dialogsOrangensaft = new Dialog[2]
{
    ...
    public static Dialog[] dialogsPillen = new Dialog[5]
    {
        ...
        new Dialog(Constants.PILLEN,
            new List<string>
        {
            "5 VON UNS HAST DU BEREITS GEKLAUT UND <b>ERTR�NKT</b>.",
        },
            null,
            null,
            new List<NpcStatePair>
    ...
    public static Dialog[] dialogsSchrank = new Dialog[3]
   {
        ...
        {
            "Ich bin geschlossen.",
            "Aber wenn du den Schl�ssel von mir findest, dann �ffne ich dir alle T�re dieser Welt."
        },
            null,
            null,
            null
    ...
    public static Dialog[] dialogsToaster = new Dialog[4]
    {
        new Dialog(Constants.TOASTER,
            new List<string>
        {
            "*Eugh, Hust*� Zu� *Hust* viele.. Kr�mell *Hust, Hust*.",
    ...
    public static Dialog[] dialogsVase = new Dialog[1]
    {
            ...
            new List<string>
        {
            ...
            "Pflanze 1: Ne dieses mal hat sie einen Kuchen mitgebracht. Extra f�r Mama gebacken.",
    ...
    public static Dialog[] dialogsVodka = new Dialog[1]
    {
        new Dialog(Constants.VODKA,
            new List<string>
        {
            "Ich schmeck dir doch eh nicht. Lass mich lieber Papa �brig"
        },
            null,
            null,
            null)
    ...
    public static Dialog[] dialogsWaschmaschine = new Dialog[3]
    {
        ...
        new Dialog(Constants.WASCHMASCHINE,
            new List<string>
        { 
            "Wei�t du? Auch wenn Oma manchmal etwas grausam zu Mama ist, ist sie doch viel zu <b>lieb</b> um etwas b�ses zu tun."
        },
            null,
            null,
            null)
    ...
    public static Dialog[] dialogsWasserkocher = new Dialog[5]
    {
        new Dialog(Constants.WASSERKOCHER,
            new List<string>
        {
            "Ich finde deine Worte �berfl�ssig.",
            "Haha, verstanden? �berfl�ssig! Haha."
        },
            null,
            null,
            null
        ...
        new Dialog(Constants.WASSERKOCHER, 
            new List<string>
        {
            "Und wieder in deine H�nde, wie s��!"
        },
            null,
            null,
            new List<NpcStatePair>
