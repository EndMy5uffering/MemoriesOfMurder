...
public static class Constants
{
    ...
    public const int FERNSEHER_INT = 2;
    public const int HOCKER_INT = 4;
    public const int KUEHLSCHRANK_INT = 5;
    public const int LAPPE_INT = 3;
    public const int MUELLEIMER_INT = 5;
    public const int ORANGENSAFT_INT = 4;
    public const int PILLEN_INT = 0;
    public const int SCHLUESSEL_INT = 3;
    public const int TEEKANNE_INT = 1;
