...
public static class Constants
{
    ...
    public const int HOCKER_INT = 3;
    public const int KUEHLSCHRANK_INT = 4;
    public const int LAPPE_INT = 5;
    public const int MUELLEIMER_INT = 6;
    public const int ORANGENSAFT_INT = 7;
    public const int PILLEN_INT = 8;
    public const int SCHLUESSEL_INT = 9;
    public const int TEEKANNE_INT = 10;
    public const int TOASTER_INT = 11;
    public const int VASE_INT = 12;
    public const int VODKA_INT = 13;
